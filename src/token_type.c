...
static const char* const _TokenTypeTranslation[] =
{
  ...
  [LOGICAL_NOT] = "LOGICAL_NOT", [LOGICAL_AND] = "LOGICAL_AND", [LOGICAL_OR] = "LOGICAL_OR",
  [LESS_THAN] = "LESS_THAN", [GREATER_THAN] = "GREATER_THAN", [LESS_THAN_EQUALS] = "LESS_THAN_EQUALS", [GREATER_THAN_EQUALS] = "GREATER_THAN_EQUALS",
  ...
  [EQUALS] = "EQUALS", [EQUALITY] = "EQUALITY", [LOGICAL_NOT_EQUALS] = "LOGICAL_NOT_EQUALS",
  ...
  [BITWISE_XOR_EQUALS] = "XOR_EQUALS", [BITWISE_AND_EQUALS] = "AND_EQUALS", [BITWISE_OR_EQUALS] = "OR_EQUALS", [BITWISE_NOT_EQUALS] = "BITWISE_NOT_EQUALS",
